                ...
                <table class="table table-striped">
                    ...
                    <?php
                          ...
                          if (isset($_GET['delete'])) {
                              ...
                              $sql = "delete from book where b_id=".$_GET['delete'];
                    ...
                    $res=mysqli_query($conn,$q) or die("Can't Execute Query...");
                      ...
                      while($row=mysqli_fetch_assoc($res))
                      {
                        ...
                        echo '<tr>';
                            ...
                            echo '<td><a href="manage_books.php?delete='.$row["b_id"].'"><button type="button" class="btn btn-danger" onclick="deletePrompt()">Delete</button></a></td>';
