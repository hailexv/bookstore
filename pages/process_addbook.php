...
require('config.php');
	...
	if(!empty($_POST))
	{
		...
		else
		{
			...
			$query="insert into book(b_nm,b_subcat,b_desc,b_edition,b_publisher,b_page,b_price,b_img,b_pdf)
			values('$b_nm','$b_cat','$b_desc','$b_edition','$b_publisher',$b_pages,$b_price,'$b_img','$b_pdf')";
