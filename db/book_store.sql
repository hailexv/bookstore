...
--
-- Host: localhost
-- Generation Time: Jun 22, 2018 at 10:26 AM
...
(52, 'proxy', '2', 'proxyyyyyy', 'proxy', '5th', '', 230, 100, 'upload_image/images(1).jpg', 'upload_ebook/OTGv4.pdf'),
...
(51, '', '1', 'hey hey hey', 'test', 'test', '', 12, 12, 'upload_image/images(2).jpg', 'upload_ebook/hash.txt'),
...
INSERT INTO `contact` (`con_id`, `con_nm`, `con_book`) VALUES
(7, 'demo', 'A Dictionary of Architecture '),
(12, 'demo', 'proxy');
